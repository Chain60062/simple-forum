...
export const createUser = async (req, res, next) => {
    try {
        ...
        const sqlQuery = 'INSERT INTO profile(cipher, avatar, profile_name, profile_role, is_verified, nickname, email) VALUES($1, $2, $3, $4, $5, $6, $7)';
...
export const editUser = async (req, res, next) => {
    try {
        ...
        const sqlQuery = 'UPDATE profile SET cipher = $1, avatar = $2, profile_name = $3, nickname = $4, email = $5 WHERE profile_id = $6 RETURNING avatar, profile_name, nickname, email';
